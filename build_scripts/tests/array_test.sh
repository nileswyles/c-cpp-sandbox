...
SRC_FILES="
-s $WYLESLIBS_WORKSPACE_ROOT_DIR/lib/test/array_test.cpp 
...
CMD="$WYLESLIBS_WORKSPACE_ROOT_DIR/build_scripts/build_common.sh -n array_test $SRC_FILES --log $LOG_LEVEL -L$WYLESLIBS_WORKSPACE_ROOT_DIR/build_systems $DEFINES$TEST_ARG"
echo "    "$CMD
exec $CMD