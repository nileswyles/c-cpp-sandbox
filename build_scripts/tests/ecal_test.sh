...
SRC_FILES="
-s $WYLESLIBS_WORKSPACE_ROOT_DIR/lib/test/ecal_test.cpp
-s $WYLESLIBS_WORKSPACE_ROOT_DIR/lib/ecal.cpp
-s $WYLESLIBS_WORKSPACE_ROOT_DIR/lib/etime.cpp
-s $WYLESLIBS_WORKSPACE_ROOT_DIR/lib/test/stubs/etime.cpp
...
CMD="$WYLESLIBS_WORKSPACE_ROOT_DIR/build_scripts/build_common.sh -n ecal_test $SRC_FILES --log $LOG_LEVEL $DEFINES$TEST_ARG"
echo "    "$CMD
exec $CMD