...
SRC_FILES="
-s $WYLESLIBS_WORKSPACE_ROOT_DIR/lib/test/enew_test.cpp
-s $WYLESLIBS_WORKSPACE_ROOT_DIR/lib/enew.cpp
-s $WYLESLIBS_WORKSPACE_ROOT_DIR/lib/memory/emalloc.c
-s $WYLESLIBS_WORKSPACE_ROOT_DIR/lib/memory/heap.c
...
CMD="$WYLESLIBS_WORKSPACE_ROOT_DIR/build_scripts/build_common.sh -n enew_test $SRC_FILES --log $LOG_LEVEL $DEFINES$TEST_ARG"
echo "    "$CMD
exec $CMD