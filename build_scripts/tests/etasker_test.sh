...
SRC_FILES="
-s $WYLESLIBS_WORKSPACE_ROOT_DIR/lib/test/etasker_test.cpp
...
CMD="$WYLESLIBS_WORKSPACE_ROOT_DIR/build_scripts/build_common.sh -n etasker_test $SRC_FILES --log $LOG_LEVEL $DEFINES$TEST_ARG"
echo "    "$CMD
exec $CMD