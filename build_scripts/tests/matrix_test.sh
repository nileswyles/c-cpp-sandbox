...
SRC_FILES="
-s $WYLESLIBS_WORKSPACE_ROOT_DIR/lib/test/matrix_test.cpp
...
CMD="$WYLESLIBS_WORKSPACE_ROOT_DIR/build_scripts/build_common.sh -n matrix_test $SRC_FILES --log $LOG_LEVEL $DEBUG$DEFINES$TEST_ARG"
echo "    "$CMD
exec $CMD