...
static void parse(ByteEStream * io, SharedArray<MultipartFile> files, std::unordered_map<std::string, std::string> form_content, std::shared_ptr<FileManager> file_manager) {
